...
def entry():
    ...
    tkinter.messagebox.showinfo("Готово", "Вы зарегистрированы")
...
def apo_details():
    ...
    if int(p1) == 1:
        ...
        det = (
            ...
            "время:-", p3,
            "Куда:-", o)
        query = 'replace into appointment_details values("{}", "{}", "{}", "{}")'.format(p1, p2, p3, o)
        cur.execute(query)
...
b3 = Button(image=image2, command=create_window)
